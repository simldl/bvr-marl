#!/usr/bin/env python3
"""
BVR-MARL-Core visualization launcher — unified interface for all visualization modes.
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Launch BVR-MARL-Core visualization",
...
Examples:
  ...
  python scripts/visualization/live_view.py --mode commands
    ...
    print("=" * 60)
    print(f"BVR-MARL-Core Visualization Launcher ({args.mode})")
    print("=" * 60)
