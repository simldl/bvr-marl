#!/usr/bin/env python3
"""
BVR-MARL Tacview scenario generation launcher — unified interface for RL and behavior-tree controllers.
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Generate BVR-MARL Tacview scenarios",
