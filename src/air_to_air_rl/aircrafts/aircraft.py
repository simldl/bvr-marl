...
from air_to_air_rl.aircrafts.systems.sensor import AircraftSensorSystem
...
from air_to_air_rl.simulator.core.events import Event
...
class Aircraft(FlyingUnit):
    def __init__(self, name, position, yaw_deg, speed_mps, group, map_limits, config):
        ...
        self.weapon_lock_threshold_km = config.get(
            "weapon_lock_threshold_km", config.get("radar_max_range_m", 20000) * 0.01 / 1000
        )
        ...
        from air_to_air_rl.aircrafts.systems.metrics_helper import MetricsHelper
