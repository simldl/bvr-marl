...
def create_sqi_aspect_angle_plot():
    ...
    ranges_for_aspect = [
        amraam_base_range_km * 0.067,
        amraam_base_range_km * 0.2,
        amraam_base_range_km * 0.333,
        amraam_base_range_km * 0.467,
        amraam_base_range_km * 0.6,
    ]  # 10, 30, 50, 70, 90 km for 150 km AMRAAM
