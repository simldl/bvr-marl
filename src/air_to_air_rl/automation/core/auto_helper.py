...
class AutoHelper:
    ...
    def __init__(self, aircraft, config: AutoHelperConfig | None = None):
    ...
    def get_action_values(
        self, simulator, dt: float, manual_controls: dict[str, float]
    ) -> np.ndarray:
        """
        ...
        Ps = manual_controls.get(
            "Ps", manual_controls.get("Ps_cmd", manual_controls.get("energy", 0.5))
        )
        n = manual_controls.get("n", manual_controls.get("n_cmd", 0.5))
        phi = manual_controls.get("phi", manual_controls.get("phi_cmd", 0.5))
    ...
    def get_status(self) -> dict[str, Any]:
        ...
        return {
            ...
            if hasattr(self, "threat_assessment")
            else None,
        }
