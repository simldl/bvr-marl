...
from air_to_air_rl.missiles.core.movement import MissileMovement
...
from air_to_air_rl.simulator.core.hit_calculation import MissileHitCalculator
...
class Missile(FlyingUnit):
    ...
    def update(self, tick_secs: float, sim: Simulator) -> list[Event]:
        ...
        yaw, pch = self.guidance.compute_guidance(
            self, self.target_provider, self.radar.tracker_manager, tick_secs
        )
