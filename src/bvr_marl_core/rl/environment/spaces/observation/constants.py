...
# Ownship state
d_OWN = 21
"""Ownship state dimension (21 features):
...
[9-13]:  Envelope scalars (s_factor, c_factor) and radar features
[14-16]: Radar features (max_range, FOV, power normalized)
[17]:    Own RCS normalized
[18]:    Radar lock quality [0-1]
[19-20]: Boundary distances normalized (min of 4 directions)
"""
