...
class DataLink:
    ...
    def _shared_source_detections(self, src_radar, src_pos, own_position):
        ...
        if (base > 0.0 or per_km > 0.0) and hasattr(src_radar, "get_delayed_detections"):
            ...
            return src_radar.get_delayed_detections(delay_s) or []
        return src_radar.cached_detections or []
        ...
        if mode == "own":
            ...
            for src_radar, src_pos in group_radars or []:
                if (
                    ...
                    for d in self._shared_source_detections(src_radar, src_pos, own_position):
                        detections.append(
            ...
            if len(own_target_ids) > 0:
                for src_radar, src_pos in group_radars or []:
                    ...
                    if (
                        ...
                        src_dets = self._shared_source_detections(src_radar, src_pos, own_position)
                        for d in src_dets:
