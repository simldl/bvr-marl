...
Pure-math helpers with no ML/RL dependencies — safe to import from any
controller or observation builder.
"""
...
def enu_delta_meters(unit, other):
    ...
    """
    dE = (
        (other.position.lon - unit.position.lon)
        * 111_000.0
        * math.cos(math.radians(unit.position.lat))
    )
