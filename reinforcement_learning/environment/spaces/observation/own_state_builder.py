...
class OwnStateBuilder:
    ...
    def _get_radar_features(self, unit, obs_helper, target) -> list:
        ...
        if hasattr(unit, 'radar'):
            ...
            tx_p = getattr(radar, 'tx_power_w', getattr(radar, 'power_w', getattr(radar, 'power', 0.0)))
        ...
        return [radar_max_range_norm, radar_fov_norm, own_rcs_norm, radar_power_norm, radar_lock_quality]
