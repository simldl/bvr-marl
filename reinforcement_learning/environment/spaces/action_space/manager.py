...
class ActionSpaceManager:
    ...
    10 entries: [Ps, n, φ, target, missile_fire, gun_fire, 4×CM]
    ...
    def __init__(
        ...
        self.spaces: TypingDict[str, Box] = {
            aid: self._template for aid in self.agent_ids
        }
    ...
    def all(self) -> TypingDict[str, Box]:
