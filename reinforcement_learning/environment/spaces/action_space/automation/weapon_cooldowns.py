...
class WeaponCooldowns:
    ...
    def __init__(self, missile_cooldown_s: float = 2.0, gun_cooldown_s: float = 0.15):
        """
    ...
    def set_missile_cooldown(self, state: dict, cooldown_s: float = None):
        ...
        state['missile_cooldown_left_s'] = cooldown_s if cooldown_s is not None else self.missile_cooldown_s
