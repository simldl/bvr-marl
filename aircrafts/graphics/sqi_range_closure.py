...
def create_sqi_range_closure_plot():
    ...
    closure_rates_mps = [-400, -200, 0, 100, 200, 400, 600]  # meters per second (negative = diverging)
    ...
    for closure_rate in closure_rates_mps:
        ...
        ax.plot(range_km, sqi_values, linewidth=2.5, label=label, marker='o', markersize=4, markevery=10)

    ax.axhline(0.55, color='red', linestyle='--', linewidth=2, alpha=0.7, label='Shot Threshold (0.55)')
