...
from missiles.fox3.k77m import K77M
...
class Su57(Aircraft):
    ...
    class Config:
        ...
        radar_horizontal_fov_deg: float = 140.0   # Byelka has wide coverage with cheek arrays (sim nominal)
        radar_vertical_fov_deg: float = 60.0
        radar_max_range_m: float = 300_000.0      # public estimates vary ~200–400 km vs fighter-size target
