...
from radar.tracking.filter.coordinated_turn_filter import CoordinatedTurnKFFilter
from radar.tracking.filter.imm_filter import IMMFilter
...
def create_imm_cv_ct_filter(initial_position, dt=0.1, cv_weight=0.8):
    ...
    initial_state_8d = np.array([
        ...
        100.0, 0.0, 0.0,  # velocity magnitude, yaw, pitch
        0.0, 0.0          # turn rates
    ])
