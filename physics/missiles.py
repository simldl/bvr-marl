...
from physics.physics import get_speed_of_sound, PhysicsParams
...
class MissilePhysics(FlyingPhysics):
    ...
    class Params(PhysicsParams):
        ...
        engine_thrust_profile: dict = field(default_factory=lambda: {"full_thrust_speed": 1030.0, "optimal_speed": 1280.0})
    ...
    def get_base_drag_cd(self, v_mps: float, alt_m: float) -> float:
        ...
        if mach < self.mach_t1:
            ...
            return self.cd0_hi - 0.01 * (mach - self.mach_t4)
