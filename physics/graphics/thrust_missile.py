...
def plot_missile_thrust() -> plt.Figure:
    ...
    ax.plot(time_s, thrust_generic, color='blue', linewidth=2.5,
            label='Medium-Range (AMRAAM-like)')
    ax.plot(time_s, thrust_longrange, color='red', linewidth=2.0, linestyle='--',
            label='Long-Range (Meteor-like)')
    ax.plot(time_s, thrust_shortrange, color='green', linewidth=2.0, linestyle=':',
