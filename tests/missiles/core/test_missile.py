...
class TestMissile:
    ...
    def test_missile_initialization(self, mock_source, mock_target, mock_map_limits, sample_config):
        ...
        with (
            patch("air_to_air_rl.missiles.missile.MissilePhaseManager"),
            patch("air_to_air_rl.missiles.missile.MissileEngine"),
            patch("air_to_air_rl.missiles.missile.MissilePhysics"),
            patch("air_to_air_rl.missiles.missile.MissileMovement"),
            patch("air_to_air_rl.missiles.missile.MissileRadar"),
            patch("air_to_air_rl.missiles.missile.GuidanceTargetProvider"),
            patch("air_to_air_rl.missiles.missile.MissileGuidance"),
            patch("air_to_air_rl.missiles.missile.MissileHitCalculator"),
        ):
            missile = Missile(
                name="Test_Missile",
                firing_time_s=0.0,
    ...
    def test_missile_component_initialization(
        ...
        with (
            patch("air_to_air_rl.missiles.missile.MissilePhaseManager") as mock_phase_mgr,
            patch("air_to_air_rl.missiles.missile.MissileEngine") as mock_engine,
            patch("air_to_air_rl.missiles.missile.MissilePhysics") as mock_physics,
            patch("air_to_air_rl.missiles.missile.MissileMovement") as mock_movement,
            patch("air_to_air_rl.missiles.missile.MissileRadar") as mock_radar,
            patch("air_to_air_rl.missiles.missile.GuidanceTargetProvider") as mock_target_provider,
            patch("air_to_air_rl.missiles.missile.MissileGuidance") as mock_guidance,
            patch("air_to_air_rl.missiles.missile.MissileHitCalculator") as mock_hit_calc,
        ):
            missile = Missile(
                name="Test_Missile",
                firing_time_s=0.0,
    ...
    def test_missile_update_cycle(self, mock_source, mock_target, mock_map_limits, sample_config):
        ...
        with (
            ...
            # These should be called based on the actual update method
    ...
    def test_missile_radar_initialization(
        ...
        with (
            patch("air_to_air_rl.missiles.missile.MissilePhaseManager", Mock()),
            patch("air_to_air_rl.missiles.missile.MissileEngine", Mock()),
            patch("air_to_air_rl.missiles.missile.MissilePhysics", Mock()),
            patch("air_to_air_rl.missiles.missile.MissileMovement", Mock()),
            patch("air_to_air_rl.missiles.missile.MissileRadar", Mock()) as mock_radar,
            patch("air_to_air_rl.missiles.missile.GuidanceTargetProvider", Mock()),
            patch("air_to_air_rl.missiles.missile.MissileGuidance", Mock()),
            patch("air_to_air_rl.missiles.missile.MissileHitCalculator", Mock()),
            patch("air_to_air_rl.missiles.missile.DataLink", Mock()),
        ):
            missile = Missile(
                name="Test_Missile",
                firing_time_s=0.0,
