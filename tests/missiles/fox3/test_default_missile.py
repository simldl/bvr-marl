...
class TestLongRangeMissile:
    ...
    def mock_map_limits(self):
        ...
        return {"lat_min": 44.0, "lat_max": 48.0, "lon_min": 1.0, "lon_max": 5.0}
    ...
    def test_long_range_missile_initialization(self, mock_source, mock_target, mock_map_limits):
        ...
        with patch(
            "air_to_air_rl.missiles.missile.Missile.__init__", return_value=None
        ) as mock_init:
            LongRangeMissile(
                firing_time_s=0.0,
                target=mock_target,
    ...
    def test_long_range_missile_radar_configuration(
    ...
    def test_long_range_missile_performance_characteristics(
        self, mock_source, mock_target, mock_map_limits
    ):
    ...
    def test_long_range_vs_amraam_comparison(self, mock_source, mock_target, mock_map_limits):
        ...
        with patch(
            ...
            assert (
                long_range_config["radar"]["horizontal_fov_deg"]
                > amraam_config["radar"]["horizontal_fov_deg"]
            )

    def test_long_range_missile_extreme_bvr_capabilities(
        self, mock_source, mock_target, mock_map_limits
    ):
    ...
    def test_long_range_missile_advanced_radar_features(
        self, mock_source, mock_target, mock_map_limits
    ):
    ...
    def test_long_range_missile_heavy_warhead_characteristics(
        self, mock_source, mock_target, mock_map_limits
    ):
