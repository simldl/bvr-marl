...
def test_pn_guidance():
    ...
    try:
        ...
        target = create_test_aircraft("Target", 0.009, 0.009, 10000, 225, "RED")  # ~1.4km NE, moving SW
    ...
    original_select_phase = missile.guidance._select_guidance_phase
    ...
    print(f"Target is moving (should help PN intercept)")
