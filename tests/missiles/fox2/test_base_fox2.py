...
class TestFox2Missile:
    ...
    def test_fox2_missile_import(self):
        ...
        from air_to_air_rl.missiles.fox2.base_fox2 import Fox2Missile
    ...
    def test_fox2_missile_initialization(self, mock_source, mock_target, mock_map_limits):
        ...
        with (
            patch.multiple(
                "air_to_air_rl.missiles.missile",
                MissileEngine=Mock(),
            ...
            patch("air_to_air_rl.missiles.fox2.ir_seeker.InfraredSeeker", Mock()),
        ):
            config = {
                "mass_kg": 85.0,
    ...
    def test_fox2_missile_ir_seeker(self, mock_source, mock_target, mock_map_limits):
        ...
        with (
            ...
            patch(
                "air_to_air_rl.missiles.fox2.ir_seeker.InfraredSeeker", Mock()
    ...
    def test_fox2_missile_step(self, mock_source, mock_target, mock_map_limits):
        ...
        with (
            ...
            patch("air_to_air_rl.missiles.missile.MissileGuidance", Mock()) as mock_guidance,
            patch("air_to_air_rl.missiles.missile.MissilePhaseManager", Mock()) as mock_phase_mgr,
            patch("air_to_air_rl.missiles.missile.MissileHitCalculator", Mock()),
            patch("air_to_air_rl.missiles.missile.MissilePhysics", Mock()),
            patch("air_to_air_rl.missiles.missile.MissileRadar", Mock()),
            patch("air_to_air_rl.missiles.fox2.ir_seeker.InfraredSeeker", Mock()),
        ):
            # Configure mocks
