...
class TestMovingAverageFilter:
    ...
    def test_moving_average_import(self):
        ...
        from bvr_marl_core.missiles.guidance.utils import MovingAverageFilter
...
class TestCircularMovingAverageFilter:
    ...
    def test_circular_average_import(self):
        ...
        from bvr_marl_core.missiles.guidance.utils import CircularMovingAverageFilter
...
class TestDistanceFunction:
    ...
    def test_distance_import(self):
        ...
        from bvr_marl_core.missiles.guidance.utils import distance_m
    ...
    def test_distance_calculation(self):
        ...
        with patch("bvr_marl_core.missiles.guidance.utils.geodetic_distance_km") as mock_distance:
