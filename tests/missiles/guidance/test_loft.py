...
class TestLoftGuidance:
    ...
    def test_loft_guidance_import(self):
        ...
        try:
            ...
            pytest.skip("LoftGuidance not available")
    ...
    def test_loft_guidance_initialization(self, mock_missile):
        ...
        try:
            ...
            pytest.skip("LoftGuidance dependencies not available")
    ...
    def test_loft_guidance_forced_climb(self, mock_missile, mock_target_position):
        ...
        try:
            ...
            with patch('missiles.guidance.loft.geodetic_bearing_deg') as mock_bearing:
                ...
                result = LoftGuidance.compute(mock_missile, mock_target_position)
                ...
                mock_bearing.assert_called_once_with(
                    mock_missile.position.lat, mock_missile.position.lon,
    ...
    def test_loft_guidance_near_target_altitude(self, mock_missile, mock_target_position):
        ...
        try:
            ...
            result = LoftGuidance.compute(mock_missile, mock_target_position, alt_guard_m=1500.0)
    ...
    def test_loft_guidance_default_target_altitude(self, mock_missile, mock_target_position):
        ...
        try:
            ...
            with patch('missiles.guidance.loft.geodetic_bearing_deg') as mock_bearing:
                ...
                result = LoftGuidance.compute(mock_missile, mock_target_position, min_loft_range_m=1000.0)
    ...
    def test_loft_guidance_range_too_close(self, mock_missile, mock_target_position):
        ...
        try:
            ...
            result = LoftGuidance.compute(mock_missile, mock_target_position, min_loft_range_m=50000.0)
