...
class TestLeadInterceptGuidance:
    ...
    def test_lead_intercept_no_target_velocity(
        ...
        with (
            patch("air_to_air_rl.missiles.guidance.lead.geodetic_to_enu") as mock_enu,
            patch(
                "air_to_air_rl.missiles.guidance.lead.DirectPursuitGuidance"
    ...
    def test_lead_intercept_with_target_velocity(
        ...
        with patch("air_to_air_rl.missiles.guidance.lead.geodetic_to_enu") as mock_enu:
