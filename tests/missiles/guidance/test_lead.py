...
class TestLeadInterceptGuidance:
    ...
    def mock_missile(self):
        ...
        # Return None by default so fallback falls through to get_guidance_velocity
        missile.target_provider.get_guidance_velocity_in_missile_enu.return_value = None
        missile.target_provider.get_guidance_tid.return_value = None
        return missile
    ...
    def test_lead_intercept_no_target_velocity(
        ...
        with (
            patch("bvr_marl_core.missiles.guidance.lead.geodetic_to_enu") as mock_enu,
            patch(
                "bvr_marl_core.missiles.guidance.lead.DirectPursuitGuidance"
    ...
    def test_lead_intercept_with_target_velocity(
        self, mock_missile, mock_missile_position, mock_target_position
    ):
        """Test lead intercept calculation with target velocity."""
        from bvr_marl_core.missiles.guidance.lead import LeadInterceptGuidance

        with patch("bvr_marl_core.missiles.guidance.lead.geodetic_to_enu") as mock_enu:
    ...
    def test_lead_intercept_impossible_geometry(
        self, mock_missile, mock_missile_position, mock_target_position
    ):
    ...
    def test_lead_intercept_time_clamping(
        self, mock_missile, mock_missile_position, mock_target_position
    ):
    ...
    def test_lead_intercept_pitch_clamping(
        self, mock_missile, mock_missile_position, mock_target_position
    ):
    ...
    def test_lead_intercept_invalid_target_velocity(
        self, mock_missile, mock_missile_position, mock_target_position
    ):
        ...
        with (
            ...
            mock_missile.target_provider.get_guidance_velocity.return_value = [
                100.0,
                float("nan"),
                0.0,
            ]
    ...
    def test_lead_intercept_linear_case(
        self, mock_missile, mock_missile_position, mock_target_position
    ):
