...
class TestGuidanceTargetProvider:
    ...
    def test_guidance_target_provider_missile_filtering(
        ...
        with (
            patch(
                "air_to_air_rl.missiles.guidance.target_provider.enu_to_geodetic",
                return_value=(46.0, 3.0, 8500.0),
            ) as mock_enu,
            patch(
                "air_to_air_rl.missiles.guidance.target_provider.Position",
    ...
    def test_guidance_target_provider_dead_reckoning(self, mock_missile, mock_simulator):
        ...
        with (
            patch("air_to_air_rl.missiles.guidance.target_provider.enu_to_geodetic") as mock_enu,
            patch("air_to_air_rl.missiles.guidance.target_provider.Position") as mock_pos,
        ):
