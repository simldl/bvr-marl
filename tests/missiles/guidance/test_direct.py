...
class TestDirectPursuitGuidance:
    ...
    def test_direct_pursuit_compute_bearing(
        ...
        with (
            patch("air_to_air_rl.missiles.guidance.direct.geodetic_bearing_deg") as mock_bearing,
            patch("air_to_air_rl.missiles.guidance.direct.geodetic_distance_km") as mock_distance,
        ):
            ...
            mock_bearing.assert_called_once_with(
                mock_missile_position.lat,
                mock_missile_position.lon,
                mock_target_position.lat,
                mock_target_position.lon,
            )

    def test_direct_pursuit_compute_pitch(
        self, mock_missile, mock_missile_position, mock_target_position
    ):
    ...
    def test_direct_pursuit_same_altitude(
        self, mock_missile, mock_missile_position, mock_target_position
    ):
    ...
    def test_direct_pursuit_target_below(
        self, mock_missile, mock_missile_position, mock_target_position
    ):
    ...
    def test_direct_pursuit_zero_distance_protection(
        self, mock_missile, mock_missile_position, mock_target_position
    ):
