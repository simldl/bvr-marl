...
class TestDirectPursuitGuidance:
    ...
    def test_direct_pursuit_compute_bearing(
        ...
        with (
            patch("bvr_marl_core.missiles.guidance.direct.geodetic_bearing_deg") as mock_bearing,
            patch("bvr_marl_core.missiles.guidance.direct.geodetic_distance_km") as mock_distance,
        ):
