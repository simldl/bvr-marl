...
class TestTerminalGuidance:
    ...
    def test_terminal_guidance_import(self):
        ...
        from bvr_marl_core.missiles.guidance.terminal import TerminalGuidance
    ...
    def test_terminal_guidance_initialization(self, mock_missile):
        ...
        with (
            patch("bvr_marl_core.missiles.guidance.terminal.DirectPursuitGuidance") as mock_direct,
            patch("bvr_marl_core.missiles.guidance.terminal.PnPropNavGuidance") as mock_pn,
        ):
    ...
    def test_terminal_guidance_compute_uses_direct(
        ...
        with (
            patch(
                "bvr_marl_core.missiles.guidance.terminal.DirectPursuitGuidance"
            ) as mock_direct_class,
            patch("bvr_marl_core.missiles.guidance.terminal.PnPropNavGuidance") as mock_pn_class,
        ):
    ...
    def test_terminal_guidance_future_pn_integration(
        ...
        with (
            patch("bvr_marl_core.missiles.guidance.terminal.DirectPursuitGuidance"),
            patch("bvr_marl_core.missiles.guidance.terminal.PnPropNavGuidance") as mock_pn_class,
        ):
            guidance = TerminalGuidance(mock_missile)
