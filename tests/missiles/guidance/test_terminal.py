...
class TestTerminalGuidance:
    ...
    def test_terminal_guidance_import(self):
        ...
        try:
            ...
            pytest.skip("TerminalGuidance not available")
    ...
    def test_terminal_guidance_initialization(self, mock_missile):
        ...
        try:
            ...
            with patch('missiles.guidance.terminal.DirectPursuitGuidance') as mock_direct, \
                 patch('missiles.guidance.terminal.PnPropNavGuidance') as mock_pn:
            ...
            pytest.skip("TerminalGuidance dependencies not available")

    def test_terminal_guidance_compute_uses_direct(self, mock_missile, mock_missile_position, mock_target_position):
        """Test that terminal guidance uses direct pursuit guidance."""
        try:
            from missiles.guidance.terminal import TerminalGuidance
            
            with patch('missiles.guidance.terminal.DirectPursuitGuidance') as mock_direct_class, \
                 patch('missiles.guidance.terminal.PnPropNavGuidance') as mock_pn_class:
    ...
    def test_terminal_guidance_passthrough_parameters(self, mock_missile, mock_missile_position, mock_target_position):
        ...
        try:
            ...
            with patch('missiles.guidance.terminal.DirectPursuitGuidance') as mock_direct_class:
                ...
                mock_direct_instance.compute.assert_called_once_with(
                    ...
                    mock_missile_position, mock_target_position, 
                    tick_secs
                )
    ...
    def test_terminal_guidance_multiple_calls(self, mock_missile, mock_missile_position, mock_target_position):
        ...
        try:
            ...
            with patch('missiles.guidance.terminal.DirectPursuitGuidance') as mock_direct_class:
                ...
                # First call
                yaw1, pitch1 = guidance.compute(0.0, 0.0, mock_missile_position, mock_target_position, 0.1)
                assert yaw1 == 45.0
                assert pitch1 == 5.0
                
                # Second call
                yaw2, pitch2 = guidance.compute(10.0, 2.0, mock_missile_position, mock_target_position, 0.1)
                assert yaw2 == 50.0
                assert pitch2 == 7.0
                
                # Third call
                yaw3, pitch3 = guidance.compute(20.0, 4.0, mock_missile_position, mock_target_position, 0.1)
                assert yaw3 == 55.0
                assert pitch3 == 9.0
    ...
    def test_terminal_guidance_future_pn_integration(self, mock_missile, mock_missile_position, mock_target_position):
