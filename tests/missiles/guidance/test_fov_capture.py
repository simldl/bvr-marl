...
class TestFovCaptureGuidance:
    ...
    def test_fov_capture_import(self):
        ...
        try:
            ...
            pytest.skip("FovCaptureGuidance not available")
    ...
    def test_fov_capture_initialization(self, mock_missile):
        ...
        try:
            ...
            pytest.skip("FovCaptureGuidance dependencies not available")
    ...
    def test_fov_capture_compute(self, mock_missile, mock_missile_position, mock_target_position):
        ...
        try:
            ...
            with patch('missiles.guidance.fov_capture._angles_dist') as mock_angles:
    ...
    def test_fov_capture_negative_angles(self, mock_missile, mock_missile_position, mock_target_position):
    ...
    def test_fov_capture_zero_angles(self, mock_missile, mock_missile_position, mock_target_position):
    ...
    def test_fov_capture_large_angles(self, mock_missile, mock_missile_position, mock_target_position):
    ...
    def test_fov_capture_proportional_correction(self, mock_missile, mock_missile_position, mock_target_position):
        ...
        try:
            ...
            with patch('missiles.guidance.fov_capture._angles_dist') as mock_angles:
                ...
                yaw1, pitch1 = guidance.compute(current_yaw, current_pitch, 
                                              mock_missile_position, mock_target_position, 0.1)
                
                # Test with larger angle error
                mock_angles.return_value = (10.0, 4.0, 1000.0)
                yaw2, pitch2 = guidance.compute(current_yaw, current_pitch,
                                              mock_missile_position, mock_target_position, 0.1)
