...
class TestSkyflash:
    ...
    def test_skyflash_import(self):
        ...
        try:
            ...
            pytest.skip("Skyflash not available")
    ...
    def test_skyflash_initialization(self, mock_source, mock_target, mock_map_limits):
        ...
        try:
            ...
            pytest.skip("Skyflash dependencies not available")
    ...
    def test_skyflash_vs_sparrow_differences(self, mock_source, mock_target, mock_map_limits):
        ...
        try:
            ...
            with patch('missiles.fox1.base_fox1.Fox1Missile.__init__', return_value=None) as mock_init:
                ...
                assert skyflash_config['motor_burn_s'] > sparrow_config['motor_burn_s']  # Longer burn time
                assert skyflash_config['life_time_s'] > sparrow_config['life_time_s']  # Longer range
                assert skyflash_config['radar']['fov_deg'] < sparrow_config['radar']['fov_deg']  # Narrower FOV
                
        except ImportError:
            pytest.skip("Skyflash/Sparrow comparison not available")
