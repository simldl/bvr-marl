import numpy as np
import math
from reinforcement_learning.environment.spaces.obs_helper import (
    rel_state, pad_generic, pad_indices, pad_cached, extract_feature_matrix, build_warn_sector_features, onehot_encode, mask_for_units
)
...
def test_mask_for_units():
    l = [object(), None, object()]
    mask = mask_for_units(l, 4)
