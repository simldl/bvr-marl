import numpy as np
from reinforcement_learning.environment.spaces.obs_space_manager import EnvConfig, ObservationSpaceManager
...
def test_observation_space_manager():
    ...
    assert space["own_state"].shape == (22,)  # Updated from 15
    ...
    assert space["enemy_fighters"].shape == (1 * 9,)  # Updated from 7 to 9 dims/slot (includes NEZ)
