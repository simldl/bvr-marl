...
class MockSimulator:
    ...
    def get_units_by_group(self, group):
        ...
        return [unit for unit in self.active_units.values() 
...
class MockEnvironment:
    ...
    def step(self, action):
        ...
        controlled_units = [unit for unit in self.scenario.simulator.active_units.values()
    ...
    def _calculate_reward(self):
        ...
        # Penalty for enemies
        enemy_units = [unit for unit in self.scenario.simulator.active_units.values()
