...
from air_to_air_rl.physics.physics import AIRSPEED_OF_SOUND, AirLayer, get_speed_of_sound
...
class TestMissilePhysicsParams:
    ...
    def test_default_params(self):
        ...
        params = MissilePhysics.Params(mass_kg=500.0, reference_area_m2=0.3)
...
class TestMissilePhysicsInit:
    ...
    def basic_params(self):
        return MissilePhysics.Params(mass_kg=600.0, reference_area_m2=0.35, air=AirLayer())
    ...
    def test_energy_protections_disabled(self, missile):
        ...
        assert not missile.enable_energy_protections
...
class TestMissilePhysicsEngineModel:
    ...
    def missile(self):
        params = MissilePhysics.Params(
            mass_kg=400.0, reference_area_m2=0.25, air=AirLayer(), constant_engine_F=18000.0
        )
        return MissilePhysics(params)
...
class TestMissilePhysicsLimitsAndConstraints:
    ...
    def missile(self):
        params = MissilePhysics.Params(
            mass_kg=500.0, reference_area_m2=0.3, air=AirLayer(), n_max=40.0
        )
        return MissilePhysics(params)
...
class TestMissilePhysicsIntegration:
    ...
    def test_missile_high_speed_performance(self, realistic_missile):
        ...
        result = realistic_missile.compute_movement(pos, 0.0, 0.0, 0.0, 0.0, 1100.0, 1.0, 3.0)
    ...
    def test_missile_climb_performance(self, realistic_missile):
        ...
        result = realistic_missile.compute_movement(pos, 0.0, 0.0, 45.0, 45.0, 600.0, 1.0, 5.0)
    ...
    def test_missile_maneuverability(self, realistic_missile):
        ...
        # Large turn command
        result = realistic_missile.compute_movement(pos, 0.0, 180.0, 0.0, 0.0, 700.0, 1.0, 2.0)
    ...
    def test_missile_no_energy_protections(self, realistic_missile):
        ...
        result = realistic_missile.compute_movement(pos, 0.0, 0.0, 60.0, 60.0, low_speed, 1.0, 2.0)
...
class TestMissilePhysicsEdgeCases:
    ...
    @pytest.fixture
    def missile(self):
        params = MissilePhysics.Params(mass_kg=300.0, reference_area_m2=0.2, air=AirLayer())
        return MissilePhysics(params)
    ...
    def test_extreme_altitudes(self, missile):
        ...
        result = missile.compute_movement(pos_high, 0.0, 0.0, 0.0, 0.0, 500.0, 1.0, 2.0)
    ...
    def test_zero_speed_handling(self, missile):
        ...
        pos = Position(0.0, 0.0, 5000.0)
        result = missile.compute_movement(pos, 0.0, 90.0, 0.0, 15.0, 0.0, 1.0, 1.0)
...
class TestMissilePhysicsPerformanceEnvelope:
    ...
    def test_high_g_capability(self, performance_missile):
        ...
        result = performance_missile.compute_movement(pos, 0.0, 120.0, 0.0, 0.0, 800.0, 1.0, 1.0)
    ...
    def test_speed_envelope(self, performance_missile):
        ...
        for speed in speeds:
            pos = Position(0.0, 0.0, 6000.0)
            result = performance_missile.compute_movement(pos, 0.0, 0.0, 0.0, 0.0, speed, 1.0, 2.0)
    ...
    def test_energy_characteristics(self, performance_missile):
        ...
        result = performance_missile.compute_movement(pos, 0.0, 0.0, 30.0, 30.0, 300.0, 1.0, 4.0)
    ...
    def test_missile_vs_aircraft_comparison(self, performance_missile):
        ...
        # 2. Higher T/W ratio
        tw_ratio = performance_missile.constant_engine_F / (
            performance_missile.mass_kg * performance_missile.g
        )
        assert tw_ratio > 5.0  # Much higher than aircraft ~1.2

        # 3. No energy protections
        assert not performance_missile.enable_energy_protections
        ...
        performance_missile.get_base_drag_cd(300.0, 5000.0)
