...
from air_to_air_rl.physics.physics import AIRSPEED_OF_SOUND, AirLayer
...
class TestAircraftPhysicsParams:
    ...
    def test_default_params(self):
        ...
        params = AircraftPhysics.Params(mass_kg=20000.0, reference_area_m2=50.0)
...
class TestAircraftPhysicsInit:
    ...
    def basic_params(self):
        return AircraftPhysics.Params(mass_kg=20000.0, reference_area_m2=50.0, air=AirLayer())
...
class TestAircraftPhysicsSmoothstep:
    ...
    @pytest.fixture
    def aircraft(self):
        params = AircraftPhysics.Params(mass_kg=15000.0, reference_area_m2=30.0)
...
class TestAircraftPhysicsDragModel:
    ...
    def test_drag_varies_with_mach_compatibility(self):
        ...
        params = AircraftPhysics.Params(mass_kg=20000.0, reference_area_m2=50.0, air=AirLayer())
...
class TestAircraftPhysicsLoadFactors:
    ...
    def test_load_factor_altitude_effects(self, aircraft):
        ...
        aircraft.compute_sustained_load_factor(300.0, 0.0, 1.0)
...
class TestAircraftPhysicsTurnRates:
    ...
    def aircraft(self):
        params = AircraftPhysics.Params(
            mass_kg=18000.0, reference_area_m2=40.0, air=AirLayer(), n_max=9.0
        )
        return AircraftPhysics(params)
...
class TestAircraftPhysicsIntegration:
    ...
    def test_energy_management_realistic(self, realistic_aircraft):
        ...
        result = realistic_aircraft.compute_movement(pos, 0.0, 0.0, 25.0, 25.0, 180.0, 1.0, 5.0)
