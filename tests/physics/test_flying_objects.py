...
from air_to_air_rl.physics.flying_objects import FlyingPhysics
from air_to_air_rl.physics.physics import AIRSPEED_OF_SOUND, AirLayer, PhysicsParams
...
class TestFlyingPhysics:
    ...
    def test_init(self, flying_physics, basic_params):
        ...
        assert flying_physics.enable_energy_protections
    ...
    def test_is_in_stall_condition(self, flying_physics):
        ...
        assert flying_physics.is_in_stall_condition(
            v_stall_dynamic * 0.9, 5000.0, 2.0
        )  # sqrt(2) * stall speed
...
class TestFlyingPhysicsIntegration:
    ...
    def test_straight_level_flight(self, flying_physics):
        ...
        result = flying_physics.compute_movement(pos, 0.0, 0.0, 0.0, 0.0, 250.0, 0.8, 10.0)
    ...
    def test_climbing_flight(self, flying_physics):
        ...
        result = flying_physics.compute_movement(pos, 0.0, 0.0, 15.0, 15.0, 220.0, 1.0, 15.0)
    ...
    def test_descending_flight(self, flying_physics):
        ...
        result = flying_physics.compute_movement(pos, 0.0, 0.0, -10.0, -10.0, 280.0, 0.3, 20.0)
    ...
    def test_turning_flight(self, flying_physics):
        ...
        result = flying_physics.compute_movement(pos, 0.0, 90.0, 0.0, 5.0, 250.0, 0.9, 8.0)
    ...
    def test_energy_protection_stall_prevention(self, flying_physics):
        ...
        result = flying_physics.compute_movement(
            ...
            low_speed,
            0.5,
            3.0,  # Moderate throttle and pitch
        )
        ...
        final_stall_speed = (
            flying_physics._dynamic_stall(alt2) if flying_physics.stall0_mps else 100.0
        )
    ...
    def test_stall_recovery_override(self, flying_physics):
        ...
        result = flying_physics.compute_movement(pos, 0.0, 0.0, 20.0, 20.0, test_speed, 0.5, 3.0)
        ...
        if flying_physics.stall0_mps:
            flying_physics._dynamic_stall(alt2)
    ...
    def test_high_altitude_performance(self, flying_physics):
        ...
        result = flying_physics.compute_movement(pos, 0.0, 0.0, 10.0, 10.0, 200.0, 1.0, 10.0)
...
class TestFlyingPhysicsEdgeCases:
    ...
    @pytest.fixture
    def flying_physics(self):
        params = PhysicsParams(mass_kg=10000.0, reference_area_m2=20.0, air=AirLayer())
    ...
    def test_zero_speed_handling(self, flying_physics):
        ...
        # Zero speed
        result = flying_physics.compute_movement(pos, 0.0, 90.0, 0.0, 10.0, 0.0, 1.0, 1.0)
    ...
    def test_extreme_altitudes(self, flying_physics):
        ...
        result = flying_physics.compute_movement(pos_high, 0.0, 0.0, 0.0, 0.0, 200.0, 1.0, 5.0)
        ...
        result = flying_physics.compute_movement(pos_low, 0.0, 0.0, 0.0, 0.0, 200.0, 1.0, 5.0)
    ...
    def test_extreme_attitudes(self, flying_physics):
        ...
        # Extreme pitch
        result = flying_physics.compute_movement(pos, 0.0, 0.0, 89.0, 89.0, 200.0, 1.0, 2.0)

        assert all(math.isfinite(x) for x in result)

        # Large yaw changes
        result = flying_physics.compute_movement(pos, 0.0, 359.0, 0.0, 0.0, 200.0, 1.0, 2.0)
    ...
    def test_extreme_time_steps(self, flying_physics):
        ...
        result = flying_physics.compute_movement(pos, 0.0, 0.0, 0.0, 0.0, 200.0, 1.0, 1e-6)
        ...
        # Large time step
        result = flying_physics.compute_movement(pos, 0.0, 0.0, 0.0, 0.0, 200.0, 1.0, 100.0)
    ...
    def test_no_stall_speed_defined(self, flying_physics):
        ...
        pos = Position(0.0, 0.0, 5000.0)
        result = flying_physics.compute_movement(pos, 0.0, 0.0, 0.0, 0.0, 10.0, 1.0, 1.0)
...
class TestFlyingPhysicsCompatibility:
    ...
    def test_compute_movement_simple_compatibility(self, flying_physics):
        ...
        res = flying_physics.compute_movement(pos, 0.0, 0.0, 0.0, 0.0, 220.0, 1.0, 5.0)
