...
class TestRLUtils:
    ...
    def sample_config(self):
        ...
        config = {
            "env": {
                ...
                "reward_normalization": {"enabled": True},
            },
            "model": {
    ...
    def test_aircraft_type_mapping(self):
        ...
        try:
            from bvr_marl_core.rl.utils.type_maps import AIRCRAFT_TYPE_MAP
    ...
    def test_simulator_integration(self, sample_config):
        ...
        try:
            ...
            with (
                ...
                patch("bvr_marl_core.rl.utils.env_creator.Simulator") as mock_sim_class,
            ):
