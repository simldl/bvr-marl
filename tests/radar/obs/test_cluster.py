...
def test_empty_cluster_returns_empty():
    clusterer = Clusterer(angular_res_deg=2.0, range_res_m=50.0)
...
def test_multiple_bins():
    clusterer = Clusterer(angular_res_deg=2.0, range_res_m=100.0)
    dets = [
...
def test_detections_are_grouped_by_discrete_bins():
    clusterer = Clusterer(angular_res_deg=5.0, range_res_m=200.0)
    dets = [
