...
class TestMapLimitsGeodeticExtents:
    ...
    @patch('simulator.utils.map_limits.Geodesic')
    ...
    def test_geodetic_calls_with_correct_parameters(self, mock_geodesic):
        ...
        expected_calls_lat = [
            ((45.0, -124.0, 47.0, -124.0), {'outmask': mock_geodesic.DISTANCE}),
            ((45.0, -120.0, 47.0, -120.0), {'outmask': mock_geodesic.DISTANCE})
        ]
        ...
        expected_calls_lon = [
            ((45.0, -124.0, 45.0, -120.0), {'outmask': mock_geodesic.DISTANCE}),
            ((47.0, -124.0, 47.0, -120.0), {'outmask': mock_geodesic.DISTANCE})
        ]
...
class TestMapLimitsIntegration:
    ...
    def test_complete_workflow(self):
        ...
        # Convert to relative
        lat_rel, lon_rel, alt_rel = limits.relative_position(original_lat, original_lon, original_alt)
    ...
    def test_extent_relationships(self):
        ...
        with patch('simulator.utils.map_limits.Geodesic') as mock_geodesic:
...
class TestMapLimitsEdgeCases:
    ...
    def test_very_high_precision_coordinates(self):
        ...
        limits = MapLimits(-122.123456789, 37.123456789, -122.123456788, 37.123456790, min_alt=99.999, max_alt=100.001)
