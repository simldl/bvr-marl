...
from bvr_marl_core.simulator.core.units import FlyingUnit, Unit, Velocity
...
class TestUnitBase:
    ...
    @patch("bvr_marl_core.simulator.core.units.normalize_angle")
...
class TestFlyingUnit:
    ...
    @patch("bvr_marl_core.simulator.core.units.geodetic_direct")
    ...
    def test_update_negative_pitch(self):
        ...
        with patch("bvr_marl_core.simulator.core.units.geodetic_direct") as mock_geodetic_direct:
...
class TestFlyingUnitEdgeCases:
    ...
    def test_multiple_consecutive_updates(self):
        ...
        with patch("bvr_marl_core.simulator.core.units.geodetic_direct", side_effect=side_effect):
            pos = Position(lat=45.0, lon=-123.0, alt=1000.0)
