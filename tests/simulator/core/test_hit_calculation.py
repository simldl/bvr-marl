...
from air_to_air_rl.simulator.core.hit_calculation import (
    HitParams,
...
class TestMissileHitCalculatorHitDetection:
    ...
    @patch(
        "air_to_air_rl.simulator.core.hit_calculation.MissileHitCalculator._compute_motion_vectors"
    )
...
class TestMissileHitCalculatorPrivateMethods:
    ...
    def test_compute_motion_vectors_with_t0_data(self):
        ...
        with patch(
            "air_to_air_rl.simulator.core.hit_calculation._latlonalt_to_local_m"
        ) as mock_convert:
