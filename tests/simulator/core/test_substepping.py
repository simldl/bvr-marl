...
from simulator.core.substepping import SubstepConfig, Substepper
...
class TestSubstepConfig:
    ...
    def test_default_initialization(self):
        ...
        assert config.physics_only == False
    ...
    def test_custom_initialization(self):
        ...
        assert config.physics_only == True
...
class MockUnit:
    ...
    def __init__(self, unit_id: int = 1, is_missile: bool = False, is_destroyed: bool = False,
                 target=None, locked_target=None, speed: float = 100.0,
                 unit_type: str = "", class_name: str = "MockUnit"):
        self.id = unit_id
...
class TestSubstepperCollectCandidates:
    ...
    @patch('simulator.core.substepping.units_distance_km')
...
class TestSubstepperRunTickWithSubsteps:
    ...
    @patch('simulator.core.substepping.Substepper._collect_candidates')
    ...
    @patch('simulator.core.substepping.Substepper._integrate_temporarily_with_restore')
    @patch('simulator.core.substepping.Substepper._collect_candidates')
...
class TestSubstepperEstimateSubsteps:
    ...
    def test_normal_relative_speed(self):
        ...
        with patch.object(substepper, '_estimate_relative_speed_mps', return_value=200.0):  # |500-300|
...
class TestSubstepperIntegrateTemporarilyWithRestore:
    ...
    @patch('simulator.core.substepping.Substepper._estimate_substeps')
    def test_full_integration_with_physics_only(self, mock_estimate):
        ...
        sim.ccd.get_begin_state = Mock(side_effect=[{'begin_missile': True}, {'begin_target': True}])
        sim.ccd.apply_state = Mock()
    ...
    def test_integration_with_hit_detection(self, mock_estimate):
        ...
        hit_calc = Mock()
        hit_calc.check_and_maybe_hit = Mock(side_effect=[
...
class TestSubstepperIntegration:
    ...
    def test_multiple_missiles_different_outcomes(self, mock_distance):
        ...
        # Mock simulator
        sim = Mock()
        sim.active_units = {1: missile1, 2: target1, 3: missile2, 4: target2, 5: missile3, 6: target3}
