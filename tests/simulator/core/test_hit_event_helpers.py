...
from simulator.core.hit_event_helpers import (
    CCDConfig,
    MissileCCDManager,
    default_on_hit,
    default_target_selector
)
from simulator.core.hit_calculation import HitParams
...
class TestDefaultOnHit:
    ...
    def test_event_logging_content(self):
        ...
        with patch('simulator.core.hit_event_helpers.UnitDestroyedEvent') as mock_event_class:
...
class MockUnit:
    ...
    def __init__(self, unit_id: int = 1, is_missile: bool = False, is_destroyed: bool = False,
                 target=None, locked_target=None, unit_type: str = "", class_name: str = "MockUnit"):
        self.id = unit_id
...
class TestMissileCCDManagerInitialization:
    ...
    def test_custom_callbacks_initialization(self):
        ...
        manager = MissileCCDManager(
            ...
            target_selector=custom_target_selector
        )
...
class TestMissileCCDManagerPostUpdateCCD:
    ...
    @patch('simulator.core.hit_event_helpers.units_distance_km')
    ...
    def test_first_time_within_lock_gate_logs_engagement(self, mock_distance):
        ...
        with patch.object(manager.hit_calc, 'check_and_maybe_hit') as mock_hit_check:
            with patch('simulator.core.hit_event_helpers.MissileEngagementEvent') as mock_event:
