import math
from simulator.core.helpers import geodetic_bearing_deg, geodetic_distance_km  
...
class DirectPursuitGuidance:
    ...
    def compute(self, current_yaw_deg, current_pitch_deg, missile_position, target_position, tick_secs):
        ...
        horizontal_distance = geodetic_distance_km(
                missile_position.lat, missile_position.lon, 0.0,
                target_position.lat,  target_position.lon,  0.0
            ) * 1000.0
