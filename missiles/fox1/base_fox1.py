...
class Fox1Missile(Missile):
    def __init__(self, name: str, firing_time_s, target, source, map_limits, group, config, data_link_mode="illumination"):
    ...
    def _init_radar(self, rc: dict, data_link_mode: str):
        from missiles.fox1.sarh_seeker import SemiActiveRadarSeeker
